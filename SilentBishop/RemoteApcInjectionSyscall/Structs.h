...
typedef struct _NT_SYSCALL
{
	...
	PVOID pSyscallOpAddr;		// the very address of 0f05c3 instruction
...
{
	NT_SYSCALL	NtCreateFile;	// benign NT API for hunting syscall address
	NT_SYSCALL	NtWriteFile;	// benign NT API for hunting syscall address
	NT_SYSCALL	NtOpenFile;		// benign NT API for hunting syscall address
	NT_SYSCALL	NtLockFile;		// benign NT API for hunting syscall address
} BENIGN_SYSCALL_TAB, * PBENIGN_SYSCALL_TAB;
